...
// Auth information
global.pairNumber = "260774358600";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["260774358600"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["260774358600"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["260774358600"];
global.OwnerName = process.env.OWNER_NAME || "MSELACHUI03 🐯💫";
global.BotName = process.env.BOT_NAME || "MSELACHUI03 🐯💫";
global.packname = process.env.PACK_NAME || "MSELACHUI03 🐯💫";
